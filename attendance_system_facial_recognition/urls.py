...
urlpatterns = [
    ...
    path('emp_add_photos/', recog_views.emp_add_photos, name='emp_add_photos'),
    ...
    path('logout/',auth_views.LogoutView.as_view(template_name='recognition/home.html'),name='logout'),
     ...
     path('mark_your_attendance', recog_views.mark_your_attendance ,name='mark-your-attendance'),
      ...
      path('view_my_attendance_employee_login_latestmonth', recog_views.view_my_attendance_employee_login_latestmonth,name='view_my_attendance_employee_login_latestmonth'),  
     path('view_attendance_month', recog_views.view_attendance_month ,name='view-attendance-month'),
      path('calculate_salary/', recog_views.calculate_salary, name='calculate_salary'),
